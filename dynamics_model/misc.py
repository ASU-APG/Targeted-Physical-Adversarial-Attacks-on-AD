...
from dynamics_model.models.controller import Controller
import gym
...
# Hardcoded for now
ASIZE, LSIZE, MSIZE, RSIZE, RED_SIZE, SIZE = \
    3, 32, 5, 256, 96, 96
...
class RolloutGenerator(object):
    ...
    def get_action_and_transition(self, obs, hidden):
        ...
        _, _, _, _, _, next_hidden = self.mdrnn(action, z, hidden)
    ...
    def rollout(self, params, render=False):
        ...
        while True:
            ...
            obs, reward, done, _, _, _, _ = self.env.step(action)
